...
namespace EMRView
{
    public class EmrFangJiaoItem : HCExpressItem
    {
        ...
        {
            aNode.Attributes["DeCode"].Value = EMR.EMRSTYLE_FANGJIAO.ToString();
            aNode.Attributes["toptext"].Value = TopText;
            aNode.Attributes["bottomtext"].Value = BottomText;
            aNode.Attributes["lefttext"].Value = LeftText;
            aNode.Attributes["righttext"].Value = RightText;
        }
